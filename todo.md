...
- [ ] Tester sur la Preview le lien de connexion Firebase, la session HTTP-only et le refus effectif des visiteurs ordinaires.
- [ ] Initialiser les 17 produits validés dans Firestore après une session administrateur réelle, sans données de commande ou client fictives.
